package me.rowwyourboat.doublelife_v2.menu.content;

import me.rowwyourboat.doublelife_v2.menu.MenuItem;
...
public final class Template {
    ...
    public static HashMap<Integer, MenuItem> getContent() {
        ...
        // top row
        for (int i = 1; i < 8; i++) {
            content.put(i, new MenuItem(null, Material.LIME_STAINED_GLASS_PANE, null, false));
        }
